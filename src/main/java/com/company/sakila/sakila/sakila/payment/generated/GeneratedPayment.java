...
public interface GeneratedPayment {
     ...
     */
    IntField<Payment, Integer> PAYMENT_ID = DatastoreFields.createIntField(
     ...
     */
    IntForeignKeyField<Payment, Integer, Customer> CUSTOMER_ID = DatastoreFields.createIntForeignKeyField(
     ...
     */
    ShortForeignKeyField<Payment, Short, Staff> STAFF_ID = DatastoreFields.createShortForeignKeyField(
        Identifier.STAFF_ID,
        Payment::getStaffId,
        Payment::setStaffId,
        Staff.STAFF_ID,
     ...
     */
    ComparableForeignKeyField<Payment, Integer, Integer, Rental> RENTAL_ID = DatastoreFields.createComparableForeignKeyField(
     ...
     */
    ComparableField<Payment, BigDecimal, BigDecimal> AMOUNT = DatastoreFields.createComparableField(
        Identifier.AMOUNT,
        Payment::getAmount,
        Payment::setAmount,
        TypeMapper.identity(),
     ...
     */
    ComparableField<Payment, Timestamp, Timestamp> PAYMENT_DATE = DatastoreFields.createComparableField(
     ...
     */
    ComparableField<Payment, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
