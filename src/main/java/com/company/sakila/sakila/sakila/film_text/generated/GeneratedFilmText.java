...
public interface GeneratedFilmText {
     ...
     */
    ShortField<FilmText, Short> FILM_ID = DatastoreFields.createShortField(
        Identifier.FILM_ID,
        FilmText::getFilmId,
        FilmText::setFilmId,
     ...
     */
    StringField<FilmText, String> TITLE = DatastoreFields.createStringField(
        Identifier.TITLE,
        FilmText::getTitle,
        FilmText::setTitle,
        TypeMapper.identity(),
     ...
     */
    StringField<FilmText, String> DESCRIPTION = DatastoreFields.createStringField(
