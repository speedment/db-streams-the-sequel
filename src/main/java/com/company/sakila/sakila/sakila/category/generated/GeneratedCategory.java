...
public interface GeneratedCategory {
     ...
     */
    ShortField<Category, Short> CATEGORY_ID = DatastoreFields.createShortField(
     ...
     */
    StringField<Category, String> NAME = DatastoreFields.createStringField(
        Identifier.NAME,
        Category::getName,
        Category::setName,
        TypeMapper.identity(),
     ...
     */
    ComparableField<Category, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
