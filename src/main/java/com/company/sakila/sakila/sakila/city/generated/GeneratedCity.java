...
public interface GeneratedCity {
     ...
     */
    IntField<City, Integer> CITY_ID = DatastoreFields.createIntField(
        Identifier.CITY_ID,
        City::getCityId,
        City::setCityId,
     ...
     */
    StringField<City, String> CITY = DatastoreFields.createStringField(
        Identifier.CITY,
        City::getCity,
        City::setCity,
        TypeMapper.identity(),
     ...
     */
    IntForeignKeyField<City, Integer, Country> COUNTRY_ID = DatastoreFields.createIntForeignKeyField(
     ...
     */
    ComparableField<City, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
