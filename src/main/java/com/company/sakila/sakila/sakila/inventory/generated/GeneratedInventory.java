...
public interface GeneratedInventory {
     ...
     */
    IntField<Inventory, Integer> INVENTORY_ID = DatastoreFields.createIntField(
     ...
     */
    IntForeignKeyField<Inventory, Integer, Film> FILM_ID = DatastoreFields.createIntForeignKeyField(
        Identifier.FILM_ID,
        Inventory::getFilmId,
        Inventory::setFilmId,
        Film.FILM_ID,
     ...
     */
    ShortForeignKeyField<Inventory, Short, Store> STORE_ID = DatastoreFields.createShortForeignKeyField(
        Identifier.STORE_ID,
     ...
     */
    ComparableField<Inventory, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
