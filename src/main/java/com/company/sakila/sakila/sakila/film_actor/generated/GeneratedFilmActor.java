...
public interface GeneratedFilmActor {
     ...
     */
    IntForeignKeyField<FilmActor, Integer, Actor> ACTOR_ID = DatastoreFields.createIntForeignKeyField(
        Identifier.ACTOR_ID,
     ...
     */
    IntForeignKeyField<FilmActor, Integer, Film> FILM_ID = DatastoreFields.createIntForeignKeyField(
        Identifier.FILM_ID,
        FilmActor::getFilmId,
        FilmActor::setFilmId,
        Film.FILM_ID,
     ...
     */
    ComparableField<FilmActor, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
