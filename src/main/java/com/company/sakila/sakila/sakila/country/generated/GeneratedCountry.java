...
public interface GeneratedCountry {
     ...
     */
    IntField<Country, Integer> COUNTRY_ID = DatastoreFields.createIntField(
     ...
     */
    StringField<Country, String> COUNTRY = DatastoreFields.createStringField(
        Identifier.COUNTRY,
        Country::getCountry,
        Country::setCountry,
        TypeMapper.identity(),
     ...
     */
    ComparableField<Country, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
